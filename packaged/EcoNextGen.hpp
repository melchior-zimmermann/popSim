...
#ifndef ECONEXTGEN_HPP
#define ECONEXTGEN_HPP

/**
 * @file EcoNextGen.hpp
 * @author Melchior Zimmermann
 * @date 24 Dec 2016
 * @brief File containing the definition of the implementation of the NextGen class when environmental constant is taken into account
 *
 */
...
class EcoNextGen: public NextGen{
  public:
  	/**
