...
#ifndef STDMULTINEXTGEN_HPP
#define STDMULTINEXTGEN_HPP

/**
 * @file StdMultiNextGen.hpp
 * @author Melchior Zimmermann
 * @date 24 Dec 2016
 * @brief File containing the definition of the standard implementation of the NextGen class for multi-environment simulations
 *
 */
...
class StdMultiNextGen: public NextGen{ 
  public: 
  	/**
