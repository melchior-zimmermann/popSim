...
#ifndef ECOMULTINEXTGEN_HPP
#define ECOMULTINEXTGEN_HPP

/**
 * @file EcoMultiNextGen.hpp
 * @author Melchior Zimmermann
 * @date 24 Dec 2016
 * @brief File containing the definition of the implementation of the NextGen class when the environmental constant is taken into account and it is a multi-environment simulation.
 *
 */
...
class EcoMultiNextGen: public NextGen{
  public:
  	/**
