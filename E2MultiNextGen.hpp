...
#ifndef E2MULTINEXTGEN_HPP
#define E2MULTINEXTGEN_HPP

/**
 * @file E2MultiNextGen.hpp
 * @author Melchior Zimmermann
 * @date 24 Dec 2016
 * @brief File containing the definition of the implementation of the NextGen class when evolution is on, the environmental constant is taken into account and it is a multi-environment simulation.
 *
 */
...
class E2MultiNextGen: public NextGen{
  public:
  	/**
