...
/**
 * @file RKEvoNextGen.hpp
 * @author Melchior Zimmermann
 * @date 24 Dec 2016
 * @brief File containing the definition of the implementation of the NextGen class using rk4 when evolution is on
 *
 */
...
#ifndef RKEVONEXTGEN_HPP
#define RKEVONEXTGEN_HPP

class RKEvoNextGen: public NextGen{
  public:
  	/**
