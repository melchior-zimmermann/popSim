 ...
 * @date 24 Dec 2016
 * @brief File containing the definition of the implementation of the NextGen class when evolution is on and environmental constant is taken into account
 *
 */
...
#ifndef E2NEXTGEN_HPP
#define E2NEXTGEN_HPP

class E2NextGen: public NextGen{
  public:
  	/**
