...
#ifndef STDNEXTGEN_HPP
#define STDNEXTGEN_HPP

/**
 * @file StdNextGen.hpp
 * @author Melchior Zimmermann
 * @date 24 Dec 2016
 * @brief File containing the definition of the standard implementation of the NextGen class
 *
 */
...
class StdNextGen: public NextGen{
  public:
  	/**
