...
#ifndef RKE2MULTINEXTGEN_HPP
#define RKE2MULTINEXTGEN_HPP

/**
 * @file RKE2MultiNextGen.hpp
 * @author Melchior Zimmermann
 * @date 24 Dec 2016
 * @brief File containing the definition of the implementation of the NextGen class using rk4 when evolution is on, the environmental constant is taken into account and it is a multi-environment simulation.
 *
 */
...
class RKE2MultiNextGen: public NextGen{
  public:
  	/**
  	*\brief Method used to update Species density at each timestep
  	*
  	* This method works exactly like the one in E2NextGen, except that species with
